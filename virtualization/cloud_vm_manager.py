...
class AzureProvider(CloudProviderBase):
    ...
    def create_instance(self, config: CloudVMConfig, name: str) -> str:
        ...
        try:
            from azure.mgmt.compute.models import HardwareProfile, OSProfile, \\
                NetworkProfile, NetworkInterfaceReference, VirtualMachine
    ...
    def list_instances(self) -> List[Dict]:
        try:
            ...
            } for vm in vms if vm.tags and vm.tags.get('Project') == 'zen-ai-pentest']
        except Exception as e:
            logger.error(f"List Fehler: {e}")
            return []
...
class GCPProvider(CloudProviderBase):
    ...
    def create_instance(self, config: CloudVMConfig, name: str) -> str:
        ...
        try:
            ...
            instance.labels = {
                ...
                **{k.replace('-', '_'): v for k, v in (config.tags or {}).items()}
            }
    ...
    def list_instances(self) -> List[Dict]:
        try:
            ...
            } for instance in instances if instance.labels and instance.labels.get('project') == 'zen-ai-pentest']
        except Exception as e:
            logger.error(f"List Fehler: {e}")
            return []
...
class CloudVMManager:
    ...
    def create_instance(self, provider_name: str, config: CloudVMConfig, 
                       name: str) -> str:
    ...
    def execute_ssh_command(self, instance_id: str, command: str,
                          ssh_key_path: str, username: str = "ubuntu") -> tuple:
    ...
    def create_kali_instance(self, provider_name: str, region: str, 
                            name: str = "zen-kali-pentest") -> str:
...
def create_azure_manager(subscription_id: str, tenant_id: str, 
                        client_id: str, client_secret: str) -> CloudVMManager:
