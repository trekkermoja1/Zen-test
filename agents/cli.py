            ...
            try:
                ...
                if command in ("quit", "exit"):
                    ...
                    thread_id = await self.integration.conduct_research(
                        topic=args,
                        pentest_context={"target_type": "unknown", "initiated_by": "user"}
                    )
                    print(colorize(f"[+] Research thread started: {thread_id}", "green"))
                    print(colorize("[*] Agents are working... Check status for updates", "yellow"))
                    ...
                    print(colorize(f"[*] Agent responses: {len(results.get('agent_responses', {}))}", "cyan"))
                    ...
                    for agent_id, agent in self.integration.agent_orchestrator.agents.items():
