...
class NucleiIntegration:
    ...
    async def scan_target(self, target: str, 
                         ...
                         rate_limit: int = 150) -> List[NucleiFinding]:
        """
...
"""
    ...
    def get_critical_cves(self) -> List[Dict]:
        ...
        critical_cves = [
            {"id": "CVE-2024-XXXX", "name": "Placeholder for latest critical CVEs", "severity": "critical"},
            {"id": "CVE-2023-44487", "name": "HTTP/2 Rapid Reset", "severity": "critical"},
            {"id": "CVE-2023-38545", "name": "cURL SOCKS5 heap buffer overflow", "severity": "high"},
            {"id": "CVE-2023-29357", "name": "Microsoft SharePoint Privilege Escalation", "severity": "critical"},
            {"id": "CVE-2023-21716", "name": "Microsoft Word Remote Code Execution", "severity": "critical"},
            {"id": "CVE-2022-44877", "name": "CentOS Web Panel RCE", "severity": "critical"},
            {"id": "CVE-2022-42889", "name": "Apache Commons Text RCE (Text4Shell)", "severity": "critical"},
            {"id": "CVE-2022-41741", "name": "VMware Workspace ONE Access RCE", "severity": "critical"},
            {"id": "CVE-2022-26134", "name": "Atlassian Confluence OGNL Injection", "severity": "critical"},
            {"id": "CVE-2022-22965", "name": "Spring Framework RCE (Spring4Shell)", "severity": "critical"},
            {"id": "CVE-2022-22947", "name": "Spring Cloud Gateway RCE", "severity": "critical"},
            {"id": "CVE-2021-44228", "name": "Log4j RCE (Log4Shell)", "severity": "critical"},
            {"id": "CVE-2021-45046", "name": "Log4j Denial of Service", "severity": "critical"},
            {"id": "CVE-2021-41773", "name": "Apache Path Traversal", "severity": "critical"},
            {"id": "CVE-2021-3129", "name": "Laravel Ignition RCE", "severity": "critical"},
            {"id": "CVE-2020-1472", "name": "Zerologon", "severity": "critical"},
            {"id": "CVE-2020-14882", "name": "Oracle WebLogic RCE", "severity": "critical"},
            {"id": "CVE-2019-19781", "name": "Citrix ADC RCE (Shitrix)", "severity": "critical"},
            {"id": "CVE-2019-11510", "name": "Pulse Secure VPN Arbitrary File Reading", "severity": "critical"},
            {"id": "CVE-2018-13379", "name": "Fortinet VPN Path Traversal", "severity": "critical"},
            {"id": "CVE-2017-0144", "name": "EternalBlue (MS17-010)", "severity": "critical"},
            {"id": "CVE-2017-5638", "name": "Apache Struts RCE", "severity": "critical"},
        ]
...
class NucleiTemplateManager:
    ...
    def create_template(self, template_id: str, name: str, severity: str,
                       request: Dict, matchers: List[Dict], 
                       description: str = "") -> str:
