...
from modules.tool_orchestrator import ToolOrchestrator, PENTEST_TOOLS
...
@click.option('--type', 'scan_type', default='tcp_syn', 
...
@cli.command()
@click.argument('target')
@click.option('--type', 'scan_type', default='web',
