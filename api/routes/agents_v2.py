...
from agents.v2.auth_manager import AgentAuthenticator, AgentRole, AgentCredentials
from agents.v2.agent_client import AgentConnectionError
        ...
        while True:
            ...
            if msg_type == "message":
                ...
                if recipient == "broadcast":
                    ...
                    await agent_manager.send_message(recipient, {
                        "type": "message",
                        "sender": identity.agent_id,
                        "payload": payload
                    })
