...
print("\n[2] Sende Test-Events...")
test_events = [
    {'severity': 'critical', 'event_type': 'sql_injection', 'source': '192.168.1.100', 
     'target': 'webapp.example.com', 'description': 'SQL Injection in login form'},
    {'severity': 'high', 'event_type': 'xss', 'source': '10.0.0.50',
     'target': 'api.example.com', 'description': 'Reflected XSS in search'},
    {'severity': 'medium', 'event_type': 'brute_force', 'source': '172.16.0.25',
     'target': 'ssh.example.com', 'description': 'Failed SSH logins'}
]
