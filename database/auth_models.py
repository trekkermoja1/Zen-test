...
def create_session(db, user_id: int, session_id: str, refresh_token_jti: str, 
...
def blacklist_token(db, jti: str, token_type: TokenType, expires_at: datetime, 
                    user_id: int = None, reason: str = "logout"):
...
def create_audit_log(db, user_id: int = None, action: str = None, 
