...
from database.auth_models import init_auth_db, Base
...
from database.auth_models import SessionLocal, create_user, get_user_by_username, UserRole
...
# Now import the app
from api.main import app, NEW_AUTH_AVAILABLE, _jwt_handler, _user_manager
...
class TestAuthIntegration:
    ...
    def test_protected_endpoint_with_auth(self, client, auth_headers):
        ...
        try:
            ...
            assert "unauthorized" not in error_str and "authentication" not in error_str, \
