...
class TestSubdomainScanner:
    ...
    def test_filter_wildcards(self, scanner):
        test_subdomains = {"www.example.com", "admin.example.com", "test12345.example.com"}
    ...
    def test_detect_technologies(self, scanner):
        headers = {"Server": "nginx/1.18.0", "X-Powered-By": "PHP/7.4.0"}
    ...
    def test_export_results_json(self, scanner):
        scanner.results = {"test.example.com": SubdomainResult(subdomain="test.example.com", status_code=200, is_alive=True)}
