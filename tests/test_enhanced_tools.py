...
from tools.ffuf_integration_enhanced import (
    FFuFIntegration, FFuFFinding, FFuFResult, directory_bruteforce_sync
)
from tools.whatweb_integration import (
    WhatWebIntegration, Technology, WhatWebResult, scan_sync
)
from tools.wafw00f_integration import (
    WAFW00FIntegration, WAFFinding, WAFW00FResult, detect_sync
)
from tools.subfinder_integration import (
    SubfinderIntegration, SubfinderResult, enumerate_sync
)
from tools.httpx_integration import (
    HTTPXIntegration, HTTPXHost, HTTPXResult, probe_sync
)
from tools.nikto_integration import (
    NiktoIntegration, NiktoFinding, NiktoResult, scan_sync
)
...
class TestEnhancedReconModule:
    ...
    def test_full_recon_structure(self):
        ...
        with patch.object(EnhancedReconModule, 'technology_detection') as mock_tech, \
