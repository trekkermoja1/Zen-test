# Discord - Manuelle Channel-Inhalte

Die folgenden Inhalte müssen manuell in Discord gepostet werden (Copy & Paste).
...
1. Öffne Discord
2. Gehe zum entsprechenden Channel
3. Kopiere den Inhalt aus diesem Dokument
4. Füge ihn in Discord ein (Ctrl+V)
5. Senden (Enter)

**Fertig!** Die Channels sind dann gefüllt.
