...
class HydraBruteForcer:
    ...
    def brute_force(self, target: str, service: str,
                   username: str = None, username_file: str = None,
                   password: str = None, password_file: str = None,
                   port: int = None, threads: int = 16) -> Dict:
        """
...
def hydra_ssh_brute(target: str, username_file: str, password_file: str) -> str:
    ...
    result = hydra.brute_force(target, "ssh", 
...
def hydra_ftp_brute(target: str, username: str, password_file: str) -> str:
    ...
    hydra = HydraBruteForcer()
    result = hydra.brute_force(target, "ftp",
                              username=username,
                              password_file=password_file)
    return "Credentials found!" if result.get('credentials_found') else "No credentials found"
