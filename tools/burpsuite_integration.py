...
class BurpSuiteAPI:
    ...
    def get_sites(self) -> List[Dict]:
        ...
        try:
            resp = requests.get(f"{self.api_url}/v1/sites", 
    ...
    def start_scan(self, site_id: str, 
                   scan_configuration: str = "Crawl and Audit") -> str:
        ...
        try:
            ...
            resp = requests.post(f"{self.api_url}/v1/scans", 
    ...
    def get_scan_results(self, scan_id: str) -> Dict:
        ...
        try:
            resp = requests.get(f"{self.api_url}/v1/scans/{scan_id}/issues",
                              headers=self.headers, verify=False)
            return resp.json()
        except Exception as e:
            return {'error': str(e)}
