...
from .jwt_handler import JWTHandler, TokenPayload, JWTError
from .password_hasher import PasswordHasher, get_password_hasher, PasswordStrengthError
from .rbac import RBACManager, get_rbac_manager, Role, Permission
from .mfa import MFAManager, get_mfa_manager, MFASetupResult, MFAVerifyResult
...
from .middleware import (
    AuthContext, AuthMiddleware, get_auth_middleware,
    require_auth, require_role, require_permission, require_mfa
)
...
async def verify_mfa_setup(
    ...
    return MFAVerifyResponse(
        success=True,
        method="totp",
        remaining_backup_codes=mfa_manager.get_remaining_backup_codes(auth.user_id)
    )
